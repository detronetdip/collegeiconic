                ...
                <div class="media align-items-center">
                    <div class="media-body mr-3">
                        <h2 class="num-text text-black font-w700">
                            <?php echo countColleges($con); ?>
                        </h2>
                        <span class="fs-14">Colleges</span>
                    </div>
        ...
        <div class="card card-bd">
            ...
            <div class="card-body">
                <div class="media align-items-center">
                    <div class="media-body mr-3">
                        <h2 class="num-text text-black font-w700">
                            <?php echo countQueries($con); ?>
                        </h2>
                        <span class="fs-14">Queries</span>
                    </div>
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
...
<div class="selectionrow">
    <div class="wrap">
        <span>Updated on 07/03/2022 at 22:19</span>
    ...
    <br>
    <div class="sectbord">
        <div class="card dts" id="dt" onclick="switchGraph(this)">
            <div class="image">
        ...
        <div class="card cts" id="ct" onclick="switchGraph(this)">
            <div class="image">
        ...
        <div class="card dvs" id="dd" onclick="switchGraph(this)">
            <div class="image">
        ...
        <div class="card pgs" id="pg" onclick="switchGraph(this)">
            <div class="image">
